...
import enteties.impl.CustomProductComparator;
...
public class DefaultProductManagementService implements ProductManagementService{
    ...
    public void shouldSortProductsAccordingCategory(){
        Collections.sort(getProducts(), new CustomProductComparator());
    ...
    public Product getProductById(int productIdToAddToCart) {
        ...
        return products.get(productIdToAddToCart-1);
    }
}
